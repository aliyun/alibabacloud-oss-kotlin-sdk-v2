...
class PutBucketLoggingTest {
    ...
    @Test
    fun serializeXmlBodyIncludesLoggingRole() {
        ...
        val xml = SerdeUtils.serializeXmlBody(bucketLoggingStatus).decodeToString()
        assertTrue(xml.contains("<TargetBucket>targetBucket</TargetBucket>"))
        assertTrue(xml.contains("<TargetPrefix>targetPrefix</TargetPrefix>"))
        assertTrue(xml.contains("<LoggingRole>loggingRole</LoggingRole>"))
    }
