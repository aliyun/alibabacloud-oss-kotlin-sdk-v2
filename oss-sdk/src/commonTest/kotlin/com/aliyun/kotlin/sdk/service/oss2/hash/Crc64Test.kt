...
private fun Long.toHex16(): String = this.toULong().toString(16).padStart(16, '0')
...
class Crc64Test {
    ...
    fun testCrc64() {
        ...
        var crc64 = Crc64(0)
        crc64.update(data1.encodeToByteArray(), 0, data1.length)
        var pat = "-7395533204333446662".toLong()
        assertEquals(pat, crc64.digestValue)

        crc64 = Crc64(data2.encodeToByteArray(), data2.length)
        ...
        crc1.update(data1.encodeToByteArray(), 0, data1.length)

        val crc2: Crc64 = Crc64()
        crc2.update(data2.encodeToByteArray(), 0, data2.length)

        val crc3: Crc64 = Crc64()
        crc3.update(total.encodeToByteArray(), 0, total.length)
    ...
    fun testCrc64AndReset() {
        ...
        // total crc
        val crc: Crc64 = Crc64()
        crc.update(data.encodeToByteArray(), 0, data.length)
    ...
    @Test
    fun testBytes() {
        val test1 = "123456789".encodeToByteArray()
        val tesLen1 = 9
        val testCrc1 = -0x66a2364420e6c606L // ECMA.
        calcAndCheck(test1, tesLen1, testCrc1)

        val test2 = "This is a test of the emergency broadcast system.".encodeToByteArray()
        val tesLen2 = 49
        val testCrc2 = 0x27db187fc15bbc72L // ECMA.
        calcAndCheck(test2, tesLen2, testCrc2)

        val test3 = "IHATEMATH".encodeToByteArray()
        val tesLen3 = 9
    ...
    private fun calcAndCheck(b: ByteArray, len: Int, crcValue: Long) {
        ...
        if (crc.digestValue != crcValue) {
            throw RuntimeException(
                "mismatch: " + crc.digestValue.toHex16() + " should be " + crcValue.toHex16()
            )
        }
