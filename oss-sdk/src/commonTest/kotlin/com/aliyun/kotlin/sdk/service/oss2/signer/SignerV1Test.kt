...
class SignerV1Test {
    ...
    @OptIn(ExperimentalTime::class)
    @Test
    fun testAuthQueryWithToken() = runTest {
        val provider =
    ...
    @OptIn(ExperimentalTime::class)
    @Test
    fun testAuthQueryParamWithToken() = runTest {
